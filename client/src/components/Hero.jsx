	...
	return (
		<section className="w-full max-w-[40rem] min-h-dvh flex items-center justify-center">
			<div>
				...
				<h1 className="font-bold text-4xl md:text-6xl text-wrap my-4">
					Your Voice. Your Story. Your Space.
				</h1>
				<p className="text-base md:text-lg text-gray-600 text-pretty mb-8">
				...
				<ButtonLink
					style="bg-gray-950 text-white border-gray-950 hover:bg-gray-800 px-16 py-3"
					path="signup">
					Get started
				</ButtonLink>
			</div>
